...
target_folder1="/home/cuiruochen/model/llava-v1.5-7b-post-${time1}-${version1}-bs-${train_bs1}-${eval_bs1}-${gradient_accumulation_steps1}-epoch-${epoch1}-gpu-${gpu1}-lr-${lr1}-ablation-llava-align-linear"
output_dir1="post_interaction_block/models/llava-v1_5/checkpoints/llava-post-${time1}-${version1}-bs-${train_bs1}-${eval_bs1}-${gradient_accumulation_steps1}-epoch-${epoch1}-gpu-${gpu1}-lr-${lr1}-ablation-llava-align-linear"
# 检查目标文件夹路径是否正确
