...
target_folder1="/home/cuiruochen/model/llava-v1.5-7b-post-${time1}-${version1}-bs-${train_bs1}-${eval_bs1}-${gradient_accumulation_steps1}-epoch-${epoch1}-gpu-${gpu1}-lr-${lr1}-align-after-align-ablation-no-cav2"
output_dir1="post_interaction_block/models/llava-v1_5/checkpoints/llava-post-${time1}-${version1}-bs-${train_bs1}-${eval_bs1}-${gradient_accumulation_steps1}-epoch-${epoch1}-gpu-${gpu1}-lr-${lr1}-align-after-align-ablation-no-cav2"
# 检查目标文件夹路径是否正确
...
# source_folder="/home/cuiruochen/model/llava-v1.5-7b-----------pib-to-be-copied"
# target_folder2="/home/cuiruochen/model/llava-v1.5-7b-post-${time2}-${version2}-bs-${train_bs2}-${eval_bs2}-${gradient_accumulation_steps2}-epoch-${epoch2}-gpu-${gpu2}-lr-${lr2}-align-after-align"
# output_dir2="post_interaction_block/models/llava-v1_5/checkpoints/llava-post-${time2}-${version2}-bs-${train_bs2}-${eval_bs2}-${gradient_accumulation_steps2}-epoch-${epoch2}-gpu-${gpu2}-lr-${lr2}-align-after-align"
# # 检查目标文件夹路径是否正确
