...
# target_folder1="/home/cuiruochen/model/llava-v1.5-7b-post-${time1}-${version1}-bs-${train_bs1}-${eval_bs1}-${gradient_accumulation_steps1}-epoch-${epoch1}-gpu-${gpu1}-lr-${lr1}-ablation-llava-no-align-mlp"
# output_dir1="post_interaction_block/models/llava-v1_5/checkpoints/llava-post-${time1}-${version1}-bs-${train_bs1}-${eval_bs1}-${gradient_accumulation_steps1}-epoch-${epoch1}-gpu-${gpu1}-lr-${lr1}-ablation-llava-no-align-mlp"
# # 检查目标文件夹路径是否正确
...
# deepspeed --include localhost:${localhost} --master_port 12143 post_interaction_block/models/llava-v1_5/train_llava_dpo_post.py \
#     --lora_enable False \
...
source_folder="/home/cuiruochen/model/llava-v1.5-7b-----------pib-to-be-copied"
target_folder2="/home/cuiruochen/model/llava-v1.5-7b-post-${time2}-${version2}-bs-${train_bs2}-${eval_bs2}-${gradient_accumulation_steps2}-epoch-${epoch2}-gpu-${gpu2}-lr-${lr2}"
output_dir2="post_interaction_block/models/llava-v1_5/checkpoints/llava-post-${time2}-${version2}-bs-${train_bs2}-${eval_bs2}-${gradient_accumulation_steps2}-epoch-${epoch2}-gpu-${gpu2}-lr-${lr2}"
# 检查目标文件夹路径是否正确
...
CUDA_VISIBLE_DEVICES=${localhost} torchrun --nproc_per_node ${gpu2} --master_port 12546 post_interaction_block/models/llava-v1_5/pope_eval_post.py \
    --coco_path post_interaction_block/data/coco2014 \
    --pope_path post_interaction_block/data/POPE \
...
source_folder="/home/cuiruochen/model/llava-v1.5-7b-----------pib-to-be-copied"
target_folder3="/home/cuiruochen/model/llava-v1.5-7b-post-${time3}-${version3}-bs-${train_bs3}-${eval_bs3}-${gradient_accumulation_steps3}-epoch-${epoch3}-gpu-${gpu3}-lr-${lr3}"
output_dir3="post_interaction_block/models/llava-v1_5/checkpoints/llava-post-${time3}-${version3}-bs-${train_bs3}-${eval_bs3}-${gradient_accumulation_steps3}-epoch-${epoch3}-gpu-${gpu3}-lr-${lr3}"
# 检查目标文件夹路径是否正确
...
deepspeed --include localhost:${localhost} --master_port 12142 post_interaction_block/models/llava-v1_5/train_llava_dpo_post.py \
    --lora_enable False \
    --deepspeed post_interaction_block/models/llava-v1_5/scripts/zero3.json \
...
CUDA_VISIBLE_DEVICES=${localhost} torchrun --nproc_per_node ${gpu3} --master_port 12546 post_interaction_block/models/llava-v1_5/pope_eval_post.py \
    --coco_path post_interaction_block/data/coco2014 \
    --pope_path post_interaction_block/data/POPE \
