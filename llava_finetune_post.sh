...
source_folder="/home/cuiruochen/model/llava-v1.5-7b-----------to-be-copied"
target_folder1="/home/cuiruochen/model/llava-v1.5-7b-train_post${version2}-${time2}-bs-${train_bs2}-${eval_bs2}-${gradient_accumulation_steps2}-epoch-${epoch2}-gpu-${gpu2}-lr-${lr2}"
output_dir1="ha_dpo/models/llava-v1_5/checkpoints/llava-post-decoder-${time2}-${version2}-bs-${train_bs2}-${eval_bs2}-${gradient_accumulation_steps2}-epoch-${epoch2}-gpu-${gpu2}-lr-${lr2}"
