...
# 加载 non_lora_trainables.bin 文件中的 lm_head 参数
non_lora_state_dict = torch.load("/home/cuiruochen/HA-DPO/ha_dpo/results/train_post-20240401-bs1-1-16-epoch-3/llava-origin/non_lora_trainables.bin")

# 加载 pytorch_model-00002-of-00002.bin 文件中的参数
model_state_dict = torch.load("/home/cuiruochen/model/llava-v1.5-7b-train_postv2-20240402-bs-1-1-16-epoch-3/pytorch_model-00002-of-00002.bin")
...
# 保存修改后的模型参数
torch.save(model_state_dict, "/home/cuiruochen/model/llava-v1.5-7b-train_postv2-20240402-bs-1-1-16-epoch-3/pytorch_model-00002-of-00002.bin")
