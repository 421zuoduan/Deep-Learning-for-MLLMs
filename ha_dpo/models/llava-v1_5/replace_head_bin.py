...
model_state_dict = torch.load("/home/cuiruochen/model/llava-v1.5-7b-train_head/pytorch_model-00002-of-00002-origin.bin")
...
# 保存修改后的模型参数
torch.save(model_state_dict, "/home/cuiruochen/model/llava-v1.5-7b-train_head/pytorch_model-00002-of-00002.bin")
