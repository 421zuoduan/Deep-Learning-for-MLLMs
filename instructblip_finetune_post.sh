...
accelerate launch --main_process_port $RANDOM ha_dpo/models/instructblip/train_instructblip_dpo_post.py \
    --lora_r 64 \
    --cfg_path post_interaction_block/models/instructblip/vigc/projects/post_interaction_block_hadpo/instruct_vicuna13b.yaml \
    ...
    --output_dir 'post_interaction_block/models/instructblip/vigc/output/instructblip_dpo_post' \
    --logging_steps 4
