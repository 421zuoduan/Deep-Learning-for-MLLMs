#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --nproc_per_node 4 --master_port 15691 post_interaction_block/models/llava-v1_5/pope_eval_post.py \
    --coco_path post_interaction_block/data/coco2014 \
    --pope_path post_interaction_block/data/POPE \
    --model-path /home/cuiruochen/model/llava-v1.5-7b-post-20240508-v8-bs-2-1-16-epoch-1-gpu-4-lr-2e-7 \
    --set popular
