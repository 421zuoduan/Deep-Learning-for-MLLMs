...
from ..post_interaction_block.post_interaction_block import PostInteractionBlock
from ..post_interaction_block.configuration_post_interaction_block import LlamaPIBConfig
...
class LlamaPIBPreTrainedModel(PreTrainedModel):
...
class LlamaModel(LlamaPIBPreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`LlamaDecoderLayer`]

    Args:
        config: LlamaPIBConfig
    """
...
class LlamaPIBForCausalLM(LlamaPIBPreTrainedModel):
    def __init__(self, config: LlamaPIBConfig):
        super().__init__(config)
...
class LlamaForSequenceClassification(LlamaPIBPreTrainedModel):
